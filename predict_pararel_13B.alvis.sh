...
do
    torchrun --nproc_per_node 2 predict_pararel.py \
        --model-dir /cephyr/users/tobiasno/Alvis/denitsa-shared/LLaMA/13B \
        ...
        --output-json data/pararel_predictions/13B/${relation}.jsonl \
        --output-preds data/pararel_predictions/13B/${relation}.preds.npy \
        --batch-size 64
done