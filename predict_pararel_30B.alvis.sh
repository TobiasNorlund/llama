...
do
    torchrun --nproc_per_node 4 predict_pararel.py \
        --model-dir /cephyr/users/tobiasno/Alvis/denitsa-shared/LLaMA/30B \
        ...
        --output-json data/pararel_predictions/30B/${relation}.jsonl \
        --output-preds data/pararel_predictions/30B/${relation}.preds.npy \
        --batch-size 64
done